            ...
            while (await _timer.WaitForNextTickAsync(cancellationToken))
            {
                ...
                foreach (var game in _gameData.GetAll())
                {
                    ...
                    foreach (var player in game.Players)
                    {
                        ...
                        {
                            // process movement
                            PlayerPositioner.MovePlayer(player, map, action.Timestamp - player.LastStateUpdate, playerHitboxRadius);
                        ...
                        PlayerPositioner.MovePlayer(player, map, now - player.LastStateUpdate, playerHitboxRadius);
